defmodule Cedar.Api01Controller do
  ...
  def admit(conn, %{ "episode" => episode, "endpoint" => endpoint }) do
    Phoenix.PubSub.broadcast "decision", {:admit, episode: episode, endpoint: endpoint}
  ...
  def discharge(conn, %{ "episode" => episode, "endpoint" => endpoint }) do
    Phoenix.PubSub.broadcast "decision", {:discharge, episode: episode, endpoint: endpoint}
  ...
  def registration(conn, %{ "pre" => pre, "post" => post, "endpoint" => endpoint }) do
    Phoenix.PubSub.broadcast "decision", {:registration, pre: pre, post: post, endpoint: endpoint}
  ...
  def preadmission(conn, %{ "pre" => pre, "post" => post, "endpoint" => endpoint }) do
    Phoenix.PubSub.broadcast "decision", {:preadmission, pre: pre, post: post, endpoint: endpoint}
  ...
  def update(conn, %{ "pre" => pre, "post" => post, "endpoint" => endpoint }) do
    Phoenix.PubSub.broadcast "decision", {:update, pre: pre, post: post, endpoint: endpoint}
